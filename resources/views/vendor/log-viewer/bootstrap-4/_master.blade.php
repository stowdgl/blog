...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('css/messenger-theme-future.css')}}">
...
<nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
    <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand mr-0">
        <i class="fa fa-fw fa-book"></i> Просмотр логов
    </a>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item {{ Route::is('log-viewer::logs.list') ? 'active' : '' }}">
                <a href="{{ route('admin-index') }}" class="nav-link">
                    <i class="fa fa-dashboard"></i> Назад в панель
                </a>
            </li>
        </ul>
    </div>
...
<footer class="main-footer">
    <div class="container-fluid">
        <p class="text-muted pull-left">
            Просмотр логов - <span class="badge badge-info">версия {{ log_viewer()->version() }}</span>
        </p>
    </div>
</footer>
